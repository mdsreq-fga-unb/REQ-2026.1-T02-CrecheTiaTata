    ...
    return (
        <>
                ...
                <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-14 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20">
                    <div className="max-w-2xl">
                        ...
                        <p className="mt-5 max-w-xl text-base leading-8 text-slate-600 sm:text-lg">
                            A Creche Tia Tata conecta doadores, voluntários e
                            famílias em uma rede de cuidado com transparência e
                            carinho.
                        </p>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <button
                                type="button"
                                onClick={() =>
                                    requireAuthForAction("/contato?acao=doar")
                                }
            ...
            <section id="necessidades" className="px-5 py-16 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
                        <div>
                            <p className="text-xl font-black uppercase tracking-wide text-orange-600 sm:text-2xl">
                                Precisamos agora
                            </p>
                            <h2 className="mt-2 text-3xl font-black text-slate-950 sm:text-4xl">
                                Doações mais urgentes
                            </h2>
                        </div>
                        <button
                            type="button"
                            onClick={() => navigateTo("/necessidades")}
                            className="inline-flex items-center gap-2 self-start rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold text-slate-700 transition hover:border-emerald-300 hover:text-emerald-700 sm:self-auto"
                        >
                        ...
                        {needs.map((item) => (
                            ...
                            >
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <span
                                        className={`rounded-full px-3 py-1 text-xs font-bold ${item.urgent ? "bg-orange-100 text-orange-700" : "bg-emerald-100 text-emerald-700"}`}
                                    >
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        navigateTo(
                                            `/doar?nome=${encodeURIComponent(item.title)}&urgencia=${encodeURIComponent(item.urgent ? "Alta" : "Baixa")}&descricao=${encodeURIComponent(item.detail)}`,
                                        )
                                    }
                ...
                <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p className="mt-5 leading-8 text-slate-600">
                            Somos um projeto social que apoia crianças e
                            famílias em situação de vulnerabilidade, organizando
                            doações, voluntariado e ações de suporte
                            comunitário.
                        </p>
                        <button
                            type="button"
            ...
            <section className="px-5 py-16 lg:px-8">
                <div className="mx-auto max-w-7xl">
                    <h2 className="text-center text-3xl font-black text-slate-950 sm:text-4xl">
                        Nosso impacto
                    </h2>
                    <div className="mt-8 grid gap-5 sm:grid-cols-3">
                        {impact.map((item) => (
                            <div
                                key={item.label}
                                className="rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200"
                            >
                                <p className="text-4xl font-black text-emerald-700 sm:text-5xl">
                                    {item.value}
                                </p>
