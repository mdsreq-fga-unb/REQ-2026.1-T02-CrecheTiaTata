    ...
    <section id="ajudar" className="bg-emerald-700 px-5 py-16 text-white lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <button type="button" onClick={() => requireAuthForAction('/contato?acao=voluntario')} className="rounded-xl border border-emerald-300 px-6 py-4 text-center font-bold text-white">
            Ser voluntário
          </button>
        </div>
      </div>
