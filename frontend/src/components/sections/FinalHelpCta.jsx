    ...
    <section className="bg-emerald-700 px-5 py-16 text-center text-white lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <button type="button" onClick={() => navigateTo('/contato')} className="rounded-xl bg-white px-6 py-4 font-bold text-emerald-700">
            Quero doar
          </button>
          <button type="button" onClick={() => navigateTo('/contato')} className="rounded-xl border border-emerald-300 px-6 py-4 font-bold text-white">
