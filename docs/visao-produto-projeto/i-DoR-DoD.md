...
| 2 | A *issue* possui critérios de aceitação | Mínimo de 2 critérios de aceitação com comportamento esperado |
...
| 4 | A *issue* está vinculada ao requisito funcional correspondente | Título preenchido com o ID do "Requisito" (ex: RF-02) |
...
| # | Critério | Métrica de Verificação |
|---|---|---|
| 1 | Testes unitários implementados e passando | Cobertura mínima de **70%** para o código novo adicionado (verificado pelo relatório de coverage do Jest/Deno) |
...
| 5 | Todos os critérios de aceitação do item do DoR validados | Checklist da *issue* 100% marcado |
...
| 01/07/2026 | 1.2 | Atualização de DoR e DoD | Lucas Meireles | |
